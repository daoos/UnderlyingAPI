...
/** An HTTP response. */
public class HttpResponseForBaiduMetasearch implements Response {
  ...
  public HttpResponseForBaiduMetasearch(HttpBase http, URL url)
    throws Exception {
    ...
    try {
      ...
      if ((userAgent == null) || (userAgent.length() == 0)) {
        System.out.println("User-agent is not set!");
      } else {
